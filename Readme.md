...
* [alfred-workflow-todoist](https://github.com/moranje/alfred-workflow-todoist) - Add tasks to your Todoist inbox or list upcoming tasks straight from Alfred.
...
* [awe](https://github.com/importre/alfred-awe) - Search awesome projects!
...
* [AnyBar Workflow](https://github.com/raguay/MyAlfred) - A workflow to work with the AnyBar.app free applicaiton.
...
* [Autojump](https://github.com/lepht/alfred-autojump-workflow) - This is an Alfred 2 workflow to provide you a faster way to navigate your filesystem via autojump
...
* [BOFH Excuses](https://github.com/medienlampe/alfred2-bofhexcuses) - This workflow returns a BOFH excuse.
...
* [Compress and escape JSON](https://github.com/ubuntudroid/alfred-json-compressor) - Compress and escape the selected JSON
...
* [CapKeyStone](https://github.com/alexhude/alfredworkflow-capkeystone) - Convert hex string to assembly and vice versa.
...
* [Docker Cloud](https://github.com/jayniz/alfred-dockercloud) - Quickly jump into docker cloud stacks
...
* [DockShelf Workflow](https://github.com/raguay/MyAlfred) - A workflow for automating DockShelf application.
...
* [Faker](https://github.com/kejadlen/faker.alfredworkflow) - Generates fake data for security questions, testing, etc.
...
* [Google Apps](https://github.com/PierBover/AlfredWorkflowGoogleApps) - A simple workflow for accessing Google Apps
...
* [LDAP contacts](https://github.com/frdmn/alfred-ldap) - Alfred workflow to search for telephone numbers of coworkers through an Active Directory/LDAP directory.
...
* [LibGen](https://github.com/smargh/alfred_libgen) - Search and Download pdfs and ebooks from Library Genesis
...
* [Manage Alfred Extension](https://github.com/jmjeong/alfred-extension/tree/master/managealfredextension) - Browse and Manage alfred extension
...
* [Network Location](https://github.com/deanishe/alfred-network-location) - List, filter and activate network locations from within Alfred
...
* [pass](https://github.com/MatthewWest/pass-alfred/) - Provide a minimal wrapper over the pass password manager (passwordstore.org)
...
* [Paste Giphy GIF](https://github.com/invious/giphyPaste.alfredworkflow) - think of a GIF, get it from Giphy, and paste the animated GIF where you want it
...
* [Relative Dates](https://github.com/deanishe/alfred-relative-dates) - Generate relative dates based on a simple input format
...
* [raywenderlich](https://github.com/softdevstory/alfred-workflows/tree/master/raywenderlich) - Display the recent ariticles from raywenderlich.com
...
* [RemoveQuarantine](https://github.com/vitorgalvao/alfred-workflows/tree/master/RemoveQuarantine) - Remove the quarantine attribute from your apps
...
* [RecentDownloads](https://github.com/vitorgalvao/alfred-workflows/tree/master/RecentDownloads) - List and act on the contents of your ~/Downloads directory
...
* [RunCommand](https://github.com/vitorgalvao/alfred-workflows/tree/master/RunCommand) - Run shell commands without opening a terminal

* [Reddit](https://github.com/deanishe/alfred-reddit) - Browse Reddit from Alfred

* [Screencapture Enhancer](https://github.com/ramiroaraujo/alfred-screencapture-enhancer-workflow) - Workflow to enhance OS X screencapture capabilities, particularly with the option to capture _last captured_ area and naming options.

* [Smart Folders](https://github.com/deanishe/alfred-smartfolders) - View and explore your Smart Folders (Saved Searches)
...
* [Share using Built-in Sharing](https://github.com/packal/repository/raw/master/com.vdesabou.ml.builtin.services/mountainlionbuilt-insharing.alfredworkflow) - Use Built-in sharing introduced since Mountain Lion
...
* [Swift Window Switcher](https://github.com/mandrigin/AlfredSwitchWindows) - Alfred workflow to switch between open windows in the system and Safari tabs.

* [Stack Overflow](https://github.com/Que3216/alfred-stack-overflow) - Get answers to simple questions like "python function syntax", without having to open your web browser
...
* [Symbols Search](https://github.com/bevesce/unicode-symbols-search) - find and paste unicode symbols

* [Show/Hide iTunes mini](https://github.com/sollymay/show-hide-itunes) - This little workflow lets you show/hide the iTunes window either by using a hotkey combo or by setting a keyword.

* [src from iframe](https://github.com/tgirardi/src-from-iframe) - Extracts src attribute value from iframe tag in clipboard
...
* [Shell Variables](https://github.com/hug33k/Alfred-ShellVariables) - Get your shell's variables into Alfred
...
* [ssh](https://github.com/isometry/alfred-ssh) - Open Secure SHell with smart hostname autocompletion

* [ShadowsocksController](https://github.com/yourtion/Alfred_ShadowsocksController) - ShadowsocksX controller for Alfred
...
* [Slack](https://github.com/yannickglt/alfred-slack) - Interact with slack through Alfred
...
* [Say a word](https://github.com/jinkunw/alfred-workflows) - Pronounce a word with Audio Pronunciation Service from Google
...
* [Swift Evolution Proposals](https://github.com/lorentey/alfred-swift-evolution) - An Alfred workflow for looking up Swift evolution proposals. Written in Swift, of course.

* [Search Maven Repository](https://github.com/ctwise/alfred-workflows/tree/master/maven-repository) - Search the maven repository.
...
* [Sublime Text Projects](https://github.com/deanishe/alfred-sublime-text) - View, filter and open your Sublime Text (2 and 3) project files.

* [Shakespearean Insult Generator](https://github.com/jason-dour/shakespeare-alfredworkflow) - Generate random Bard-inspired insults.
...
* [Seq-utilities](https://github.com/danielecook/seq-utilities) - Fetch complement, reverse complement, RNA, and protein sequences. Generate random DNA. Blast a sequence.

* [Search Omnifocus](https://github.com/rhydlewis/search-omnifocus) - This is a workflow that performs free text searches on OmniFocus data.
...
* [StackOverflow Search](https://github.com/deanishe/alfred-stackoverflow) - Search StackOverflow.com from Alfred
...
* [SourceTree](https://github.com/yourtion/Alfred_SourceTree) - Fast launch project in SourceTree

* [shanbay-alfred2](https://github.com/alswl/shanbay-alfred2) - com.alswl.alfred.shanbay

* [Spritzr](https://github.com/smargh/alfred_spritzr) - An Alfred Speed-Reader
...
* [Status](https://github.com/ekonstantinidis/alfred-status-workflow) - Alfred workflow that displays status of well known services like GitHub, Twitter and more.
...
* [Secure Password Generator](https://github.com/deanishe/alfred-pwgen) - Generate secure random passwords from Alfred. Uses /dev/urandom as source of entropy.

* [Search Mac App Store](https://github.com/gingerbeardman/alfred-extension) - Search the Mac App Store
...
* [Search Bear](https://github.com/ilstar/search_bear_note) - Search Bear notes by keywords and/or tags

* [SpeedTest](https://github.com/chusiang/alfred-workflows/tree/master/speedtest) - Run SpeedTest with speedtest-cli.

* [slackfred](https://github.com/fspinillo/slackfred) - Interact with the chat service Slack via Alfred (multi-org supported)

* [Say it with GIFs](https://github.com/deanishe/alfred-gifs) - Browse your horde of GIFs and get their URLs

* [Shush! — Mute your microphone](https://github.com/dpskvn/alfred-shush) - Mute/unmute the microphone quickly

* [Swift Playground Alfred Workflow](https://github.com/jimrutherford/Swift-Playground-Alfred-Workflow) - Create or open a Swift Playground through Alfred.

* [Spotify Mini Player](https://github.com/vdesabou/alfred-spotify-mini-player) - Control your Spotify library at your fingertips

* [Screen Shot](https://github.com/24says/Alfred/blob/master/Remote%20Key.alfredworkflow) - Take Screen Shot with Preview

* [Subscribe To Feed URLs](https://github.com/curioustimes/subscribe-to-feed-urls) - Subscribe to a feed URL in one of the supported RSS aggregator services.
...
* [Secure SHell](https://github.com/deanishe/alfred-ssh) - Open SSH/SFTP/mosh connections from Alfred 3 with autosuggestion of known hosts

* [Search for Gems on RubyGems.org](https://github.com/liquid/alfred-workflow-rubygems) - Search the RubyGems API from within Alfred! Use the gem command within Alfred to find gems easily.
...
* [Sourcegraph](https://github.com/sourcegraph/sourcegraph-alfred) - Sourcegraph Alfred Workflow
...
* [SEO](https://github.com/shawnrice/alfred-seo-check) - Check URLs for SEO Stats with multiple services
...
* [Speedtest](https://github.com/vyazovoi/AlfredWorkflows) - Measure internet speed with speedtest.net service

* [ShortFilms](https://github.com/vitorgalvao/alfred-workflows/tree/master/ShortFilms) - Stream from a selection of short films
...
* [Set Resolution](https://github.com/ramiroaraujo/alfred-set-resolution-workflow) - Handy workflow to change between available screen resolutions, even between normal and HiDPI mode (Retina).
...
* [Safari History Search](https://github.com/akaralar/SafariHistorySearch) - Alfred workflow to search Safari history

* [SynAnt](https://github.com/vitorgalvao/alfred-workflows/tree/master/SynAnt) - Substitute words by checking against a thesaurs

* [Slap Toolbox](https://github.com/raguay/MyAlfred) - Open files in Slap editor
...
* [Simple Reminders](https://github.com/jimo1001/alfred-reminders-workflow) - For Reminders.app
...
* [Sleep](https://github.com/Galathius/alfred-sleep-workflow) - Sleep timer for mac.

* [s3cmd Toolkit](https://github.com/raguay/MyAlfred) - Workflow for using the s3cmd command to interact with Amazon S3

* [Spillo](https://github.com/ddeville/spillo-alfred) - Search your bookmarks in Spillo
...
* [SimulatorLauncher](https://github.com/yourtion/Alfred_SimulatorLauncher) - Easy to launch simulator
...
* [Splatoon](https://github.com/flipxfx/alfred-splatoon) - A workflow with Splatoon helpers (maps, wiki)

* [Switch System Ruby](https://github.com/ramiroaraujo/alfred-switch-system-ruby-workflow) - A simple Ruby development workflow for Mavericks to switch system Ruby between 2.0.0 and 1.8.7.

* [Search PubMed](https://github.com/ctwise/alfred-workflows/tree/master/search-pubmed) - Two different methods to get autocomplete for PubMed.

* [Swift Demangle](https://github.com/kballard/swift-demangle.alfredworkflow) - Demangles Swift symbols
...
* [SupaTaggla](https://github.com/mattmcmanus/SupaTaggla-Alfred-Workflow) - Provide global hot keys to toggle the display of applicaitons

* [Snippets](https://github.com/smargh/alfred_snippets) - Simple, document-specific text snippets

* [StrongPassword](https://github.com/vitorgalvao/alfred-workflows/tree/master/StrongPassword) - Get a strong password by leveraging multiple sources

* [Skimmer](https://github.com/smargh/alfred-Skimmer) - Actions for PDF viewer Skim
...
* [Star Ratings](https://github.com/deanishe/alfred-star-ratings) - View and set ratings for your files and folders

* [tTyme](https://github.com/tschuxxi/tTyme) - Controll Tyme.app
...
* [TerminalFinder](https://github.com/LeEnno/alfred-terminalfinder) - Open currently selected Finder (or Path Finder) window in Terminal (or iTerm2) and vice versa
...
* [Toggle Function Keys](https://github.com/clokey/PublicCode/tree/master/AlfredWorkflows/FunctionToggler) - Toggle the fn key globally

* [TemplatesManager](https://github.com/vitorgalvao/alfred-workflows/tree/master/TemplatesManager) - Save and reuse files, directory structures, and urls

* [Trello Next for Alfred](https://github.com/packal/repository/raw/master/com.groenewege.trello-next/trello_next.alfredworkflow) - Retrieve your important Trello cards by list or due date

* [Translate API](https://github.com/shawnrice/alfred-translate-api) - Use the Official Google Translate API in Alfred
...
* [Thai Translation Workflow](https://github.com/raguay/MyAlfred) - A small workflow to translate English to Thai and Thai to English.
...
* [Trello for Alfred](https://github.com/dberube/trello-alfred) - Simple setup and quickly add new cards to Trello right from Alfred

* [TextSoap Cleaners](https://github.com/raguay/MyAlfred) - Evoke TextSoap on clipboard or current selection.

* [Text Tokenizer](https://github.com/ramiroaraujo/alfred-text-tokenizer-workflow) - Workflow for tokenizing different text value input, and converting them back to a string with multiple syntaxes. It was basically thought as a text exapander to convert space separated works into quoted comma separated values.
...
* [Template Workflow](https://github.com/raguay/MyAlfred) - A Handlebar templating engine expander of text snippets with optional expansion through TextExpander.

* [TaskPaper](https://github.com/robwalton/alfred-taskpaper-workflow) - Search for and create tasks in TaskPaper 3

* [Toggle/Enable/Disable Block All Incoming Connections](https://github.com/packal/repository/raw/master/me.pasine.blockconnections/block_all_incoming_connections.alfredworkflow) - Toggle/Enable/Disable Block All Incoming Connections option

* [Torrent](https://github.com/bfw/alfred-torrent) - Search for torrents, choose among the results in Alfred and start the download in uTorrent
...
* [Type Clipboard](https://github.com/ramiroaraujo/alfred-type-clipboard-workflow) - Simple workflow to _write_ the clipboard content in those situations where ```⌘ → V``` doesn't work, typically in non Cocoa application dialogs. You have to go and paste with right clicking the mouse or pad... Atrocious!!
...
* [tidy](https://github.com/importre/alfred-tidy) - https://github.com/importre/alfred-tidy
...
* [Telegram](https://github.com/Jamesits/alfred-workflow-telegram) - Multiple Telegram actions

* [Travis CI for Alfred](https://github.com/packal/repository/raw/master/com.fniephaus.travisci/travis-ci.alfredworkflow) - Quickly check build statuses on travis-ci.org
...
* [Tmux Workflow](https://github.com/ramiroaraujo/alfred-tmux-workflow) - Alfred workflow to manage tmux sessions, integrated with iTerm2. It can list current sessions, connect to them, kill them or create a new one. The connect or create action actually opens iTerm2 and connects to the session.

* [today's newsmth.net top 10 hot articles](https://github.com/tangyi/smth-top10-workflow) - 水木社区十大热门话题
...
* [Tower Repositories](https://github.com/cjlucas/tower-alfred-workflow) - Quickly access your Tower git repositories

* [Toggl](https://github.com/jason0x43/alfred-toggl) - Interact with your Toggl.com account

* [Translate Workflow - use Google or Microsoft Translate](https://github.com/pbojkov/alfred-workflow-google-translate) - Translate words or phrases using Google or Microsoft Translate.

* [Toggle IPhone Tethering](https://github.com/noma4i/workflow-iphone-tethering) - Toggle your Bluetooth PAN connection to your IPhone.

* [Trello search](https://github.com/janhenckens/alfredapp-trello) - Search for Trello boards and cards from Alfred

* [TV Shows Manager](https://github.com/Sheraff/tvshows-alfred-workflow) - Find, follow, stream, download, manage your favorite TV Shows
...
* [Text Snippets](https://github.com/rtoshiro/alfred-workflows-textshortcut) - Text Snippets!
...
* [Time Adding Workflow](https://github.com/raguay/MyAlfred/blob/master/TimeAddingWorkflow.alfredworkflow) - A simple workflow for adding together many time values.

* [Terminal Commands](https://github.com/gnestor/alfred-terminal-commands/raw/master/package/alfred-terminal-commands.alfredworkflow) - Search OS X Terminal commands by keyword

* [TextMate Favorites](https://github.com/voostindie/alfred-textmate-favorites) - Create, open and delete TextMate Favorites through Alfred

* [TeXdoc](https://github.com/egeerardyn/alfred-texdoc) - Searches your LaTeX documentation using texdoc

* [Top](https://github.com/jinkunw/alfred-workflows) - Display tasks sorted by memory usage.

* [TurnShoot](https://github.com/vitorgalvao/alfred-workflows/tree/master/TurnShoot) - A two-player game for Alfred
...
* [Todo Workflow](https://github.com/raguay/MyAlfred) - Workflow for using TaskPaper with scheduled todos and journaling.

* [trailer](https://github.com/isometry/alfredworkflows/) - Search and open iTunes Movie Trailers
...
* [Top Number Open Files Workflow](https://github.com/raguay/MyAlfred) - Lists the processes with the most files open.

* [Textwell Workflow](https://github.com/raguay/MyAlfred) - Handy function for use with the Textwell program

* [Todoist overdue to today](https://github.com/agladky/todoist-overdue-alfred) - Moves all overdue tasks to today in Todoist

* [Text Massagers](https://github.com/raguay/MyAlfred/blob/master/TextMassagers.alfredworkflow?raw=true) - Text Manipulation scripts

* [Together Import Url](https://github.com/sowicm/wf-together-import-url) - Import current tab's url to Together (selected group/folder) as pdf
...
* [TripMode](https://github.com/lid/TripMode-Workflow) - Toggles TripMode on/off
...
* [TV Show Calendar](https://github.com/marek-nogiec/alfred-tv-calendar) - Displays a list of current (today or +/- 1 day) TV shows

* [Text Case Converter in Swift](https://github.com/raguay/MyAlfred) - A case converter in Swift.

* [Toggle Fn keys as standard keys](https://github.com/riyaz/alfred-workflows/tree/master/Toggle_Fn_keys_as_standard_keys) - Toggle Fn keys as standard keys from previous state
...
* [Tea Timer](https://github.com/bvp663/steep.it-alfred) - This workflow is designed to let you quickly and easily set a tea timer from your computer using steep.it that will alert you when your tea is done.

* [Title Case Server](https://github.com/raguay/MyAlfred/blob/master/TitleCaseServer.alfredworkflow) - Makes use of a local web app to convert title case.

* [TimeClock](https://github.com/dpap31/TimeClock) - A time tracking workflow that saves punches & notes in a CSV file.
...
* [Ulysses](https://github.com/robwalton/alfred-ulysses-workflow) - Open groups or sheets in Ulysses
...
* [Urban Dictionary](https://github.com/Sheraff/urbandictionary-alfred-workflow) - workflow for Alfred App to query urbandictionary's API and return word definitions

* [Unit converter](https://github.com/WoLpH/alfred-converter) - Simple tool to convert measurements with advanced calculation support

* [Units](http://units.dnsu.ch) - Convert units, currency, length, weight, etc.
...
* [Uni Call](http://y.guiguan.net/unicall-6) - The missing universal audio, video call and text workflow for Alfred

* [UUIDgen](https://github.com/packal/repository/raw/master/uuidgen.alfred/uuidgen.alfredworkflow) - Create and paste UUIDs

* [Unlock your Mac Remote](https://github.com/gabamnml/unlock-your-mac) - Unlock your Mac with Alfred Remote iOS App
...
* [UploadFile](https://github.com/vitorgalvao/alfred-workflows/tree/master/UploadFile) - Upload files and directories for easy sharing

* [VPN Toggle](https://github.com/ctwise/alfred-workflows/tree/master/vpn-toggle) - Toggle VPN on or off.
...
* [Visual Studio Code Open](https://github.com/dpskvn/alfred-vscode) - Open current Finder folder in Visual Studio Code

* [VM Control](https://github.com/fniephaus/alfred-vmcontrol) - Control your Parallels and Virtual Box virtual machines

* [VEVO.com Quicksearch](https://github.com/cdraeger/alfred2-vevo-workflow) - Search vevo.com for videos and watch them in your browser

* [Video Downloader](https://github.com/onury/alfred-video-downloader) - Easily download videos (and/or extracting audio) from various websites such as YouTube, Vimeo, DailyMotion and more...
...
* [VideoDuration](https://github.com/vitorgalvao/alfred-workflows/tree/master/VideoDuration) - Outputs the url of a video on a supported website with its duration in square brackets
...
* [VPN Control](https://github.com/dgo-/alfred-vpn) - Toggle VPN connection for tunnelblick and build in osx vpn
...
* [VPN Switch](https://github.com/flyeek/vpn-switch) - Switch VPN on/off

* [VLC Remote Control](https://github.com/clickysteve/alfred-remote-workflows/tree/master/VLC%20Remote) - Control VLC using Alfred Remote

* [Vagrant](https://github.com/Bartzy/alfred-vagrant) - Control a Vagrant instance.

* [VPN Connections](https://git.technosorcery.net/?p=alfred-workflow-vpn.git) - Connect & Disconnect VPNs
...
* [VagrantUP](https://github.com/m1keil/alfred-vagrant-workflow) - List and control Vagrant environments with Alfred2/3

* [Viscosity VPN Manager](https://github.com/deanishe/alfred-viscosity) - Manage Viscosity VPN connections

* [Wunderlist3.alfredworkflow](https://github.com/camgnostic/Wunderlist-3-Alfred) - A Wunderlist 3 API cloud-based alfred workflow
...
* [Wi-Fi Control](https://github.com/miromannino/alfred-wifi-control) - Alfred workflow to control Wi-Fi. It can turn on, turn off, toggle or restart the Wi-Fi.

* [湾区日报(非官方)](https://github.com/yPangXie/wanqu-workflow) - 相对快捷的获取湾区日报最新一期或者指定某一期的文章.
...
* [WatchList](https://github.com/vitorgalvao/alfred-workflows/tree/master/WatchList) - Watch and manage local videos and streams

* [Wi-Fi](https://github.com/gs3/wifi-workflow) - Set Mac's Wi-Fi function to ON/OFF.
...
* [Web to IP Address](https://github.com/estiens/web_to_ip_workflow) - Looks up an IP address for a given domain name

* [Wunderlist Workflow for Alfred](https://github.com/idpaterson/alfred-wunderlist-workflow) - Unbelievably fast entry for tasks with due dates, reminders, and recurrence in Wunderlist
...
* [Wowhead](https://github.com/owenwater/alfred-wowhead) - An Alfred workflow that helps you search World of Warcraft® database provided by wowhead.com.

* [Workon Virtualenv](https://github.com/johnnycakes79/alfred-workon-virtualenv) - Workflow to list and start python virtualenvs (assumes you and have virtualenv and virtualenvwrapper installed).

* [WordsWith](https://github.com/vitorgalvao/alfred-workflows/tree/master/WordsWith) - Find words that contain a particular pattern

* [Write into Menubar (BitBar Extension)](https://github.com/yigitkonur/write-into-menubar) - To focus better for what you do - write whatever you want to your menubar.

* [WiFi Control](https://github.com/dvcrn/alfred-wifi-workflow) - Alfred workflow to turn WiFi on/off

* [WebScreenshot](https://github.com/vitorgalvao/alfred-workflows/tree/master/WebScreenshot) - Take screenshots directly to the web

* [Wikify](https://github.com/smargh/alfred_EN-Wikify) - Your little Evernote Wiki-Helper

* [Workflow Directory - Open in Finder or Terminal](https://github.com/jeeftor/AlfredWorkflowDirectory) - Same behavior as the right click menu on a workflow.  Saves you time if you are developing workflows
...
* [Wallpapers from Unsplash](https://github.com/adamdehaven/Wallpapers-from-Unsplash) - Change the wallpaper of your desktop(s) to photos from the popular Unsplash.com. Also allows saving favorite images and command line tools.

* [Web Server Header](https://github.com/chintanbuch/Alfred-Workflows/blob/master/Web%20Server%20Header.alfredworkflow) - Check webserver's header of a given website
...
* [XAMPP](https://github.com/dmnsgn/alfred-xampp-workflow) - XAMPP commands to start services without the manager

* [Xcode Cache Clean-up](https://github.com/bojan/alfred-workflows/) - Delete the contents of the infamous DerivedData, Xcode and module cache folders.

* [Yelp Search](https://github.com/packal/repository/raw/master/com.chrislau.yelpsearch/yelp_search.alfredworkflow) - Yelp Search

* [YOURLS](https://github.com/curioustimes/yourls) - Shorten URLs by using YOURLS + some extras

* [Youtrack - create issues](https://github.com/altryne/youtrack_alfred) - Creates issues in Your Youtrack installation

* [Youdao Dict](https://github.com/liszd/whyliam.workflows.youdao/releases) - 使用有道翻译你想知道的单词和语句
...
* [Yosemite Dark Mode Toggle](https://github.com/smpanaro/alfred-darkmode) - Quickly toggle between Yosemite's Dark and Light modes from Alfred.

* [Zsh Calculator](https://github.com/alexhude/alfredworkflow-zsh-calculator) - Evaluates Zsh arithmetic expressions.

* [ZotQuery](https://github.com/smargh/alfred_zotquery) - Search Zotero. From the Comfort of Your Keyboard.
...
* [Zip Info](https://github.com/raguay/MyAlfred/blob/master/ZipInfo.alfredworkflow) - Displays what is inside a zip file without uncompressing it.

* [Zebra](https://github.com/rsnts/alfred-zebra) - Alfred worflow for Zebra interaction

* [Zip Files](https://github.com/ginfuru/alfred-zip-workflow) - One of the features missing from OS X is a keyboard trigger for creating zip archive files.
